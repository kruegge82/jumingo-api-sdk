...
**girth** | **int** | Girth of the package in cm | [optional]
**first_length** | **int** | Longest side of the package in cm | [optional]
**second_length** | **int** | Second longest side of the package in cm | [optional]

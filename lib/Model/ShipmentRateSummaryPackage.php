...
/**
 * ShipmentRateSummaryPackage Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentRateSummaryPackage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentRateSummary_package';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['weight']) && ($this->container['weight'] > 9999999)) {
            $invalidProperties[] = "invalid value for 'weight', must be smaller than or equal to 9999999.";
        }

        if (!is_null($this->container['weight']) && ($this->container['weight'] < 0.1)) {
            $invalidProperties[] = "invalid value for 'weight', must be bigger than or equal to 0.1.";
        }

        if (!is_null($this->container['length']) && ($this->container['length'] > 99999)) {
        ...
        if (!is_null($this->container['width']) && ($this->container['width'] > 99999)) {
        ...
        if (!is_null($this->container['height']) && ($this->container['height'] > 99999)) {
     ...
     * Sets weight
     *
     * @param float|null $weight Weight of the package in kg
     *
     * @return self
     */
    public function setWeight($weight)
    {
        ...
        if (($weight > 9999999)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling ShipmentRateSummaryPackage., must be smaller than or equal to 9999999.');
        }
        if (($weight < 0.1)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling ShipmentRateSummaryPackage., must be bigger than or equal to 0.1.');
        }
     ...
     * Sets length
     *
     * @param int|null $length Length of the package in cm
     *
     * @return self
     */
    public function setLength($length)
    {
        ...
        if (($length > 99999)) {
            throw new \InvalidArgumentException('invalid value for $length when calling ShipmentRateSummaryPackage., must be smaller than or equal to 99999.');
        }
        if (($length < 1)) {
            throw new \InvalidArgumentException('invalid value for $length when calling ShipmentRateSummaryPackage., must be bigger than or equal to 1.');
        }
     ...
     * Sets width
     *
     * @param int|null $width Width of the package in cm
     *
     * @return self
     */
    public function setWidth($width)
    {
        ...
        if (($width > 99999)) {
            throw new \InvalidArgumentException('invalid value for $width when calling ShipmentRateSummaryPackage., must be smaller than or equal to 99999.');
        }
        if (($width < 1)) {
            throw new \InvalidArgumentException('invalid value for $width when calling ShipmentRateSummaryPackage., must be bigger than or equal to 1.');
        }
     ...
     * Sets height
     *
     * @param int|null $height Height of the package in cm
     *
     * @return self
     */
    public function setHeight($height)
    {
        ...
        if (($height > 99999)) {
            throw new \InvalidArgumentException('invalid value for $height when calling ShipmentRateSummaryPackage., must be smaller than or equal to 99999.');
        }
        if (($height < 1)) {
            throw new \InvalidArgumentException('invalid value for $height when calling ShipmentRateSummaryPackage., must be bigger than or equal to 1.');
        }

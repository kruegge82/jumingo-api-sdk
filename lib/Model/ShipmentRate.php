...
class ShipmentRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets carrier
     *
     * @param array<string,mixed>|null $carrier Carrier object returned by the API (structure may vary)
     *
     * @return self
     */
     ...
     * Sets service
     *
     * @param array<string,mixed>|null $service Service object returned by the API (structure may vary)
     *
     * @return self
     */

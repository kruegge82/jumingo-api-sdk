...
/**
 * PackageTypeDescription Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class PackageTypeDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageType_description';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Deep explanation of package name
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of package
     *
     * @return self
     */

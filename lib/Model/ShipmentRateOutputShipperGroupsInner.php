<?php
/**
 * ShipmentRateOutputShipperGroupsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ShipmentRateOutputShipperGroupsInner Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentRateOutputShipperGroupsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentRateOutput_shipperGroups_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('url_converted', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Shipper group id
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Shipper group name
     *
     * @return self
     */
     ...
     * Sets logo
     *
     * @param string|null $logo Shipper group logo
     *
     * @return self
     */
    ...
    {
        return $this->container['url_converted'];
    }

    /**
     * Sets url_converted
     *
     * @param string|null $url_converted Shipper group url
     *
     * @return self
     */
    public function setUrlConverted($url_converted)
    {
        if (is_null($url_converted)) {
            throw new \InvalidArgumentException('non-nullable url_converted cannot be null');
        }
        $this->container['url_converted'] = $url_converted;

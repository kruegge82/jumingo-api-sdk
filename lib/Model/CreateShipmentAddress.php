...
/**
 * CreateShipmentAddress Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class CreateShipmentAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateShipmentAddress';
    ...
    protected static $openAPITypes = [
        ...
        'zip' => 'string',
        'city' => 'string',
        'state' => '\kruegge82\jumingo\Model\StateCode',
        'country' => '\kruegge82\jumingo\Model\CountryCode',
        'phone' => 'string',
        'settings' => '\kruegge82\jumingo\Model\CreateShipmentAddressSettings'
    ];
    ...
    */
    ...
    public function setCompany($company)
    {
        ...
        if ((mb_strlen($company) > 35)) {
            throw new \InvalidArgumentException('invalid length for $company when calling CreateShipmentAddress., must be smaller than or equal to 35.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateShipmentAddress., must be smaller than or equal to 35.');
        }
     ...
     * Sets street
     *
     * @param string $street First address line (usually street name and house number)
     *
     * @return self
     */
    public function setStreet($street)
    {
        ...
        if ((mb_strlen($street) > 35)) {
            throw new \InvalidArgumentException('invalid length for $street when calling CreateShipmentAddress., must be smaller than or equal to 35.');
        }
    ...
    public function setStreet2($street2)
    {
        ...
        if ((mb_strlen($street2) > 35)) {
            throw new \InvalidArgumentException('invalid length for $street2 when calling CreateShipmentAddress., must be smaller than or equal to 35.');
        }
     ...
     * Sets zip
     *
     * @param string|null $zip Postal code of the address; is required if the country needs a postal code
     *
     * @return self
     */
    public function setZip($zip)
    {
        ...
        if ((mb_strlen($zip) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling CreateShipmentAddress., must be smaller than or equal to 10.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling CreateShipmentAddress., must be smaller than or equal to 30.');
        }
     ...
     * Gets state
     *
     * @return \kruegge82\jumingo\Model\StateCode|null
     */
     ...
     * Sets state
     *
     * @param \kruegge82\jumingo\Model\StateCode|null $state state
     *
     * @return self
     */
     ...
     * Gets country
     *
     * @return \kruegge82\jumingo\Model\CountryCode
     */
     ...
     * Sets country
     *
     * @param \kruegge82\jumingo\Model\CountryCode $country country
     *
     * @return self
     */
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 35)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling CreateShipmentAddress., must be smaller than or equal to 35.');
        }
     ...
     * Gets settings
     *
     * @return \kruegge82\jumingo\Model\CreateShipmentAddressSettings|null
     */
     ...
     * Sets settings
     *
     * @param \kruegge82\jumingo\Model\CreateShipmentAddressSettings|null $settings settings
     *
     * @return self
     */

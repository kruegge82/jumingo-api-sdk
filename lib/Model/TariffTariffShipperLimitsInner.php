...
/**
 * TariffTariffShipperLimitsInner Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class TariffTariffShipperLimitsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tariff_tariff_shipper_limits_inner';
    ...
    {
        $this->setIfExists('operant', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getOperant()
    {
        return $this->container['operant'];
    }

    /**
     * Sets operant
     *
     * @param string|null $operant operant
     *
     * @return self
     */
    public function setOperant($operant)
    {
        if (is_null($operant)) {
            throw new \InvalidArgumentException('non-nullable operant cannot be null');
        }
        $this->container['operant'] = $operant;

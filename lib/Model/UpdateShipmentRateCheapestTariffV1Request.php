...
/**
 * UpdateShipmentRateCheapestTariffV1Request Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class UpdateShipmentRateCheapestTariffV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateShipmentRateCheapestTariffV1_request';
    ...
    protected static $openAPITypes = [
        'shipment_ids' => 'string[]',
        'rate_input' => '\kruegge82\jumingo\Model\ShipmentCheapestRateInput'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rate_input', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets shipment_ids
     *
     * @param string[]|null $shipment_ids shipment_ids
     *
     * @return self
     */
     ...
     * Gets rate_input
     *
     * @return \kruegge82\jumingo\Model\ShipmentCheapestRateInput|null
     */
    public function getRateInput()
    {
        return $this->container['rate_input'];
    }

    /**
     * Sets rate_input
     *
     * @param \kruegge82\jumingo\Model\ShipmentCheapestRateInput|null $rate_input rate_input
     *
     * @return self
     */
    public function setRateInput($rate_input)
    {
        if (is_null($rate_input)) {
            throw new \InvalidArgumentException('non-nullable rate_input cannot be null');
        }
        $this->container['rate_input'] = $rate_input;

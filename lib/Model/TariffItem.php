...
/**
 * TariffItem Class Doc Comment
 *
 * @category Class
 * @description Tariff element as returned in ShipmentRateOutput.tariffs
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TariffItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TariffItem';
    ...
    */
     ...
     * Sets packages
     *
     * @param array<string,mixed>[]|null $packages packages
     *
     * @return self
     */
    ...
    public function setMarketingDiscount($marketing_discount)
    {
        if (is_null($marketing_discount)) {
            array_push($this->openAPINullablesSetToNull, 'marketing_discount');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('marketing_discount', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param \DateTime|null $marketing_discount_valid_until marketing_discount_valid_until
     *
     * @return self
     */
    ...
    public function setPickupSurcharge($pickup_surcharge)
    {
        if (is_null($pickup_surcharge)) {
            array_push($this->openAPINullablesSetToNull, 'pickup_surcharge');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pickup_surcharge', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets shipper
     *
     * @param array<string,mixed>|null $shipper shipper
     *
     * @return self
     */
     ...
     * Sets dates
     *
     * @param array<string,mixed>|null $dates dates
     *
     * @return self
     */

...
/**
 * CreateShipmentConnection Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class CreateShipmentConnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateShipmentConnection';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('validation_mode', $data ?? [], 'strict');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['connection_uuid'] === null) {
            $invalidProperties[] = "'connection_uuid' can't be null";
        }
        ...
        if (!is_null($this->container['validation_mode']) && !in_array($this->container['validation_mode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'validation_mode', must be one of '%s'",
                $this->container['validation_mode'],
     ...
     *
     * @param string $connection_uuid The ID of the connection to be used. Each connected e-commerce system has a Connection ID. An overview of the systems including the IDs can be found in your user account.
     *
     * @return self
     */
     ...
     *
     * @param string|null $connection_item_uuid Your individual item ID of the shipment. Mostly corresponds to the order number in your shop. Item IDs must be unique. Required for shop / e-commerce connections, optional for API connections.
     *
     * @return self
     */
    ...
    public function setValidationMode($validation_mode)
    {
        if (is_null($validation_mode)) {
            throw new \InvalidArgumentException('non-nullable validation_mode cannot be null');
        }
        $allowedValues = $this->getValidationModeAllowableValues();

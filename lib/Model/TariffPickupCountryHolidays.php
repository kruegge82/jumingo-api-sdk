...
/**
 * TariffPickupCountryHolidays Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class TariffPickupCountryHolidays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tariff_pickupCountryHolidays';
    ...
    {
        $this->setIfExists('_2018_03_30', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function get20180330()
    {
        return $this->container['_2018_03_30'];
    }

    /**
     * Sets _2018_03_30
     *
     * @param int|null $_2018_03_30 if data is a holiday
     *
     * @return self
     */
    public function set20180330($_2018_03_30)
    {
        if (is_null($_2018_03_30)) {
            throw new \InvalidArgumentException('non-nullable _2018_03_30 cannot be null');
        }
        $this->container['_2018_03_30'] = $_2018_03_30;

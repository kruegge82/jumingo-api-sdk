...
/**
 * CustomsInvoiceInput Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class CustomsInvoiceInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomsInvoiceInput';
    ...
    */
    ...
    public function setRemarks($remarks)
    {
        ...
        if ((count($remarks) > 3)) {
            throw new \InvalidArgumentException('invalid value for $remarks when calling CustomsInvoiceInput., number of items must be less than or equal to 3.');
        }
        if ((count($remarks) < 0)) {
            throw new \InvalidArgumentException('invalid length for $remarks when calling CustomsInvoiceInput., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets line_items
     *
     * @return \kruegge82\jumingo\Model\CustomsLineItemInput[]|null
     */
     ...
     * Sets line_items
     *
     * @param \kruegge82\jumingo\Model\CustomsLineItemInput[]|null $line_items line_items
     *
     * @return self
     */

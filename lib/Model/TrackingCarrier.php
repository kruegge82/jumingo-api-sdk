...
class TrackingCarrier
{
    ...
    public const BELGIUM_POST = 'belgium-post';

    public const CARGOINTL_DE = 'cargointl-de';

    public const CHRONOPOST = 'chronopost';

    public const COLISSIMO = 'colissimo';

    public const DERKURIER = 'derkurier';

    public const DHL = 'dhl';

    public const DHL_ACTIVE = 'dhl-active';

    public const DHL_GERMANY = 'dhl-germany';

    public const DPD = 'dpd';

    public const DPD_UK = 'dpd-uk';

    public const EXAPAQ = 'exapaq';

    public const FEDEX = 'fedex';

    public const GLS = 'gls';

    public const HERMES_DE = 'hermes-de';

    public const JUMINGO = 'jumingo';

    public const JUMINGO_CARGO = 'jumingo-cargo';

    public const PARCEL_FORCE = 'parcel-force';

    public const SKYNETWORLDWIDE = 'skynetworldwide';

...
/**
 * ShipmentRateSummaryTax Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentRateSummaryTax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentRateSummary_tax';
    ...
    */
     ...
     * Sets rate
     *
     * @param float|null $rate The tax rate value
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The tax name
     *
     * @return self
     */

...
/**
 * TariffTariffShipper Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class TariffTariffShipper implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tariff_tariff_shipper';
    ...
    protected static $openAPITypes = [
        ...
        'agb_link' => 'string',
        'transit_time_link' => 'string',
        'limits' => '\kruegge82\jumingo\Model\TariffTariffShipperLimitsInner[]',
        'shipper_group_name' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'tracking_link' => null,
        'agb_link' => null,
        'transit_time_link' => null,
        'limits' => null,
        'shipper_group_name' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'tracking_link' => false,
        'agb_link' => false,
        'transit_time_link' => false,
        'limits' => false,
        'shipper_group_name' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'agb_link' => 'agb_link',
        'transit_time_link' => 'transit_time_link',
        'limits' => 'limits',
        'shipper_group_name' => 'ShipperGroupName'
    ];
    ...
    protected static $setters = [
        ...
        'agb_link' => 'setAgbLink',
        'transit_time_link' => 'setTransitTimeLink',
        'limits' => 'setLimits',
        'shipper_group_name' => 'setShipperGroupName'
    ];
    ...
    protected static $getters = [
        ...
        'agb_link' => 'getAgbLink',
        'transit_time_link' => 'getTransitTimeLink',
        'limits' => 'getLimits',
        'shipper_group_name' => 'getShipperGroupName'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('agb_link', $data ?? [], null);
        $this->setIfExists('transit_time_link', $data ?? [], null);
        $this->setIfExists('limits', $data ?? [], null);
        $this->setIfExists('shipper_group_name', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getAgbLink()
    {
        return $this->container['agb_link'];
    }

    /**
     * Sets agb_link
     *
     * @param string|null $agb_link agb_link
     *
     * @return self
     */
    public function setAgbLink($agb_link)
    {
        if (is_null($agb_link)) {
            throw new \InvalidArgumentException('non-nullable agb_link cannot be null');
        }
        $this->container['agb_link'] = $agb_link;

        return $this;
    }

    /**
     * Gets transit_time_link
     *
     * @return string|null
     */
    public function getTransitTimeLink()
    {
        return $this->container['transit_time_link'];
    }

    /**
     * Sets transit_time_link
     *
     * @param string|null $transit_time_link transit_time_link
     *
     * @return self
     */
    public function setTransitTimeLink($transit_time_link)
    {
        if (is_null($transit_time_link)) {
            throw new \InvalidArgumentException('non-nullable transit_time_link cannot be null');
        }
        $this->container['transit_time_link'] = $transit_time_link;
     ...
     * Gets limits
     *
     * @return \kruegge82\jumingo\Model\TariffTariffShipperLimitsInner[]|null
     */
     ...
     * Sets limits
     *
     * @param \kruegge82\jumingo\Model\TariffTariffShipperLimitsInner[]|null $limits limits
     *
     * @return self
     */
    ...
    /**
     * Gets shipper_group_name
     *
     * @return string|null
     */
    public function getShipperGroupName()
    {
        return $this->container['shipper_group_name'];
    }

    /**
     * Sets shipper_group_name
     *
     * @param string|null $shipper_group_name shipper_group_name
     *
     * @return self
     */
    public function setShipperGroupName($shipper_group_name)
    {
        if (is_null($shipper_group_name)) {
            throw new \InvalidArgumentException('non-nullable shipper_group_name cannot be null');
        }
        $this->container['shipper_group_name'] = $shipper_group_name;

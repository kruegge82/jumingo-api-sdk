...
/**
 * CreateShipmentRate Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class CreateShipmentRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateShipmentRate';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shipper_tariff_id'] === null) {
            $invalidProperties[] = "'shipper_tariff_id' can't be null";
        }
        ...
        if ($this->container['pickup_min_time'] === null) {
            $invalidProperties[] = "'pickup_min_time' can't be null";
        }
        if ($this->container['pickup_max_time'] === null) {
            $invalidProperties[] = "'pickup_max_time' can't be null";
        }
     ...
     *
     * @param string $shipper_tariff_id The shipper tariff id
     *
     * @return self
     */
     ...
     * Sets shipping_type
     *
     * @param string $shipping_type The shipping type indicates whether the shipment must be delivered in a shop or picked up by a driver.
     *
     * @return self
     */
     ...
     * Sets pickup_date
     *
     * @param \DateTime $pickup_date The date for which the collection was arranged.
     *
     * @return self
     */
     ...
     *
     * @param string $pickup_min_time The earliest time at which the shipment is picked up.
     *
     * @return self
     */
     ...
     *
     * @param string $pickup_max_time The latest time by which the shipment is picked up.
     *
     * @return self
     */

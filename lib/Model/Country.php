...
class Country implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'iso_code' => '\kruegge82\jumingo\Model\CountryCode',
        'tax_free' => 'int',
        'name' => 'string',
        'post_code_free' => 'int',
        'settings' => 'object[]'
    ...
    protected static $setters = [
        ...
        'tax_free' => 'setTaxFree',
        'name' => 'setName',
        'post_code_free' => 'setPostCodeFree',
    ...
    protected static $getters = [
        ...
        'tax_free' => 'getTaxFree',
        'name' => 'getName',
        'post_code_free' => 'getPostCodeFree',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('post_code_free', $data ?? [], null);
    ...
    */
     ...
     * Sets iso_code
     *
     * @param \kruegge82\jumingo\Model\CountryCode|null $iso_code iso_code
     *
     * @return self
     */
     ...
     * Sets tax_free
     *
     * @param int|null $tax_free Indicates that shipping from or to this country is VAT free
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getPostCodeFree()
    {
        return $this->container['post_code_free'];
    }

    /**
     * Sets post_code_free
     *
     * @param int|null $post_code_free Indicates that country does not have post codes
     *
     * @return self
     */
    public function setPostCodeFree($post_code_free)
    {
        if (is_null($post_code_free)) {
            throw new \InvalidArgumentException('non-nullable post_code_free cannot be null');
        }
        $this->container['post_code_free'] = $post_code_free;
     ...
     * Sets settings
     *
     * @param object[]|null $settings Custom country data
     *
     * @return self
     */

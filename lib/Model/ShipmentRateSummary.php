...
/**
 * ShipmentRateSummary Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentRateSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentRateSummary';
    ...
    protected static $openAPITypes = [
        'tax_free' => 'bool',
        'tax' => '\kruegge82\jumingo\Model\ShipmentRateSummaryTax',
        'package_all' => 'bool',
        'package' => '\kruegge82\jumingo\Model\ShipmentRateSummaryPackage'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('package_all', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tax_free'] === null) {
            $invalidProperties[] = "'tax_free' can't be null";
        }
        if ($this->container['tax'] === null) {
            $invalidProperties[] = "'tax' can't be null";
        }
        if ($this->container['package_all'] === null) {
            $invalidProperties[] = "'package_all' can't be null";
        }
     ...
     * Sets tax_free
     *
     * @param bool $tax_free If the tax applicable, this property will equal false.
     *
     * @return self
     */
     ...
     * Gets tax
     *
     * @return \kruegge82\jumingo\Model\ShipmentRateSummaryTax
     */
     ...
     * Sets tax
     *
     * @param \kruegge82\jumingo\Model\ShipmentRateSummaryTax $tax tax
     *
     * @return self
     */
    ...
    {
        return $this->container['package_all'];
    }

    /**
     * Sets package_all
     *
     * @param bool $package_all If provided more than one packages and should show the word \"all\", this property will equal true.
     *
     * @return self
     */
    public function setPackageAll($package_all)
    {
        if (is_null($package_all)) {
            throw new \InvalidArgumentException('non-nullable package_all cannot be null');
        }
        $this->container['package_all'] = $package_all;
     ...
     * Gets package
     *
     * @return \kruegge82\jumingo\Model\ShipmentRateSummaryPackage
     */
     ...
     * Sets package
     *
     * @param \kruegge82\jumingo\Model\ShipmentRateSummaryPackage $package package
     *
     * @return self
     */

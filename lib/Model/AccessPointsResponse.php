...
/**
 * AccessPointsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class AccessPointsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccessPointsResponse';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'access_points' => '\kruegge82\jumingo\Model\AccessPoints[]',
        'errors' => '\kruegge82\jumingo\Model\AccessPointsResponseErrorsInner[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('access_points', $data ?? [], null);
    ...
    */
     ...
     * Gets access_points
     *
     * @return \kruegge82\jumingo\Model\AccessPoints[]|null
     */
     ...
     * Sets access_points
     *
     * @param \kruegge82\jumingo\Model\AccessPoints[]|null $access_points access_points
     *
     * @return self
     */
    public function setAccessPoints($access_points)
    {
        if (is_null($access_points)) {
            throw new \InvalidArgumentException('non-nullable access_points cannot be null');
        }
     ...
     * Gets errors
     *
     * @return \kruegge82\jumingo\Model\AccessPointsResponseErrorsInner[]|null
     */
     ...
     * Sets errors
     *
     * @param \kruegge82\jumingo\Model\AccessPointsResponseErrorsInner[]|null $errors errors
     *
     * @return self
     */

...
/**
 * ShipmentRateOutputPickupCountryHolidays Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentRateOutputPickupCountryHolidays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentRateOutput_pickupCountryHolidays';
    ...
    {
        $this->setIfExists('_1608768000', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function get1608768000()
    {
        return $this->container['_1608768000'];
    }

    /**
     * Sets _1608768000
     *
     * @param int|null $_1608768000 List of counrty holidays
     *
     * @return self
     */
    public function set1608768000($_1608768000)
    {
        if (is_null($_1608768000)) {
            throw new \InvalidArgumentException('non-nullable _1608768000 cannot be null');
        }
        $this->container['_1608768000'] = $_1608768000;

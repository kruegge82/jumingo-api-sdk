...
/**
 * TrackingStep Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class TrackingStep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrackingStep';
    ...
    */
     ...
     * Sets date
     *
     * @param string|null $date Date of tracking information
     *
     * @return self
     */
     ...
     * Sets time
     *
     * @param string|null $time Time of tracking information
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string|null $location The location of the scan. The text comes directly from the respective carrier. The format and information density varies considerably depending on the carrier and region. Mostly the country code is included, sometimes also the city.
     *
     * @return self
     */

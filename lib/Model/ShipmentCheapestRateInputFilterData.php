...
/**
 * ShipmentCheapestRateInputFilterData Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentCheapestRateInputFilterData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentCheapestRateInput_filterData';
    ...
    */
     ...
     * Sets package_types
     *
     * @param int|null $package_types Package type id
     *
     * @return self
     */
     ...
     * Sets price_max
     *
     * @param int|null $price_max Max price
     *
     * @return self
     */
     ...
     * Sets shipper_groups
     *
     * @param string[]|null $shipper_groups Shipper groups
     *
     * @return self
     */
     ...
     * Sets shipping_type
     *
     * @param int|null $shipping_type The shipping type indicates whether the shipment must be delivered in a shop or picked up by a driver.
     *
     * @return self
     */
     ...
     * Sets tariff_types
     *
     * @param string[]|null $tariff_types Tariff types
     *
     * @return self
     */

...
/**
 * ConnectionDatesAggregationInner Class Doc Comment
 *
 * @category Class
 ...
 */
class ConnectionDatesAggregationInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Connection_dates_aggregation_inner';
    ...
    */
     ...
     * Sets time
     *
     * @param string|null $time Time in H:i:s format
     *
     * @return self
     */
     ...
     * Sets minutes
     *
     * @param int|null $minutes Time minutes
     *
     * @return self
     */

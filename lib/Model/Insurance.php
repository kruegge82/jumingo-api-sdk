...
class Insurance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('min_gross', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets percent
     *
     * @param int|null $percent Percent of insurance
     *
     * @return self
     */
     ...
     * Sets min
     *
     * @param float|null $min Min amount
     *
     * @return self
     */
     ...
     * @return float|null
     */
    public function getMinGross()
    {
        return $this->container['min_gross'];
    }

    /**
     * Sets min_gross
     *
     * @param float|null $min_gross Min amount gross
     *
     * @return self
     */
    public function setMinGross($min_gross)
    {
        if (is_null($min_gross)) {
            throw new \InvalidArgumentException('non-nullable min_gross cannot be null');
        }
        $this->container['min_gross'] = $min_gross;

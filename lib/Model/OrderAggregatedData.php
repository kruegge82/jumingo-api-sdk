...
/**
 * OrderAggregatedData Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class OrderAggregatedData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderAggregatedData';
    ...
    protected static array $openAPINullables = [
        ...
        'total_orders_count' => false,
        'total_orders_value' => false,
        'average_orders_value' => false
    ];
    ...
    protected static $setters = [
        'days_since_last_order' => 'setDaysSinceLastOrder',
    ...
    protected static $getters = [
        'days_since_last_order' => 'getDaysSinceLastOrder',
    ...
    {
        $this->setIfExists('days_since_last_order', $data ?? [], null);
        $this->setIfExists('total_orders_count', $data ?? [], null);
        $this->setIfExists('total_orders_value', $data ?? [], null);
        $this->setIfExists('average_orders_value', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets days_since_last_order
     *
     * @return int|null
     */
    public function getDaysSinceLastOrder()
    {
        return $this->container['days_since_last_order'];
    }

    /**
     * Sets days_since_last_order
     *
     * @param int|null $days_since_last_order The blog article id
     *
     * @return self
     */
    public function setDaysSinceLastOrder($days_since_last_order)
    {
        if (is_null($days_since_last_order)) {
            throw new \InvalidArgumentException('non-nullable days_since_last_order cannot be null');
        }
        $this->container['days_since_last_order'] = $days_since_last_order;
     ...
     *
     * @param int|null $total_orders_count The blog article url
     *
     * @return self
     */
    public function setTotalOrdersCount($total_orders_count)
    {
        if (is_null($total_orders_count)) {
            throw new \InvalidArgumentException('non-nullable total_orders_count cannot be null');
        }
     ...
     *
     * @param float|null $total_orders_value Total user orders value
     *
     * @return self
     */
    public function setTotalOrdersValue($total_orders_value)
    {
        if (is_null($total_orders_value)) {
            throw new \InvalidArgumentException('non-nullable total_orders_value cannot be null');
        }
     ...
     *
     * @param float|null $average_orders_value Average user orders value
     *
     * @return self
     */
    public function setAverageOrdersValue($average_orders_value)
    {
        if (is_null($average_orders_value)) {
            throw new \InvalidArgumentException('non-nullable average_orders_value cannot be null');
        }

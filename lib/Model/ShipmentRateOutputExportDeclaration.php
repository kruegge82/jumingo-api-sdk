...
/**
 * ShipmentRateOutputExportDeclaration Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jumingo
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentRateOutputExportDeclaration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentRateOutput_exportDeclaration';
    ...
    protected static $openAPITypes = [
        'export_declaration_price' => 'float',
        'export_declaration_price_old' => 'float',
        'export_declaration_price_diff' => 'float'
    ];
    ...
    protected static array $openAPINullables = [
        'export_declaration_price' => false,
        'export_declaration_price_old' => false,
        'export_declaration_price_diff' => false
    ];
    ...
    protected static $attributeMap = [
        'export_declaration_price' => 'export_declaration_price',
        'export_declaration_price_old' => 'export_declaration_price_old',
        'export_declaration_price_diff' => 'export_declaration_price_diff'
    ];
    ...
    protected static $setters = [
        'export_declaration_price' => 'setExportDeclarationPrice',
        'export_declaration_price_old' => 'setExportDeclarationPriceOld',
        'export_declaration_price_diff' => 'setExportDeclarationPriceDiff'
    ];
    ...
    protected static $getters = [
        'export_declaration_price' => 'getExportDeclarationPrice',
        'export_declaration_price_old' => 'getExportDeclarationPriceOld',
        'export_declaration_price_diff' => 'getExportDeclarationPriceDiff'
    ];
    ...
    {
        $this->setIfExists('export_declaration_price', $data ?? [], null);
        $this->setIfExists('export_declaration_price_old', $data ?? [], null);
        $this->setIfExists('export_declaration_price_diff', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets export_declaration_price
     *
     * @return float|null
     */
    public function getExportDeclarationPrice()
    {
        return $this->container['export_declaration_price'];
    }

    /**
     * Sets export_declaration_price
     *
     * @param float|null $export_declaration_price export_declaration_price
     *
     * @return self
     */
    public function setExportDeclarationPrice($export_declaration_price)
    {
        if (is_null($export_declaration_price)) {
            throw new \InvalidArgumentException('non-nullable export_declaration_price cannot be null');
        }
        $this->container['export_declaration_price'] = $export_declaration_price;

        return $this;
    }

    /**
     * Gets export_declaration_price_old
     *
     * @return float|null
     */
    public function getExportDeclarationPriceOld()
    {
        return $this->container['export_declaration_price_old'];
    }

    /**
     * Sets export_declaration_price_old
     *
     * @param float|null $export_declaration_price_old export_declaration_price_old
     *
     * @return self
     */
    public function setExportDeclarationPriceOld($export_declaration_price_old)
    {
        if (is_null($export_declaration_price_old)) {
            throw new \InvalidArgumentException('non-nullable export_declaration_price_old cannot be null');
        }
        $this->container['export_declaration_price_old'] = $export_declaration_price_old;

        return $this;
    }

    /**
     * Gets export_declaration_price_diff
     *
     * @return float|null
     */
    public function getExportDeclarationPriceDiff()
    {
        return $this->container['export_declaration_price_diff'];
    }

    /**
     * Sets export_declaration_price_diff
     *
     * @param float|null $export_declaration_price_diff export_declaration_price_diff
     *
     * @return self
     */
    public function setExportDeclarationPriceDiff($export_declaration_price_diff)
    {
        if (is_null($export_declaration_price_diff)) {
            throw new \InvalidArgumentException('non-nullable export_declaration_price_diff cannot be null');
        }
        $this->container['export_declaration_price_diff'] = $export_declaration_price_diff;

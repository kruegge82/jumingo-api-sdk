...
class CarrierApi
{
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\kruegge82\jumingo\Model\AccessPointsResponse[]',
                        $request,
                        $response,
                    );
            }
    ...
    public function v1CarrierAccessPointsSearchPostRequest($access_point_search, string $contentType = self::contentTypes['v1CarrierAccessPointsSearchPost'][0])
    {
        ...
        $resourcePath = '/v1/carrier/access-points-search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($access_point_search)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($access_point_search));
            } else {
                $httpBody = $access_point_search;
            }

...
class CartApi
{
    ...
    /**
     * Operation postCartTotal
     *
     * Get cart total
     *
     * @param  \kruegge82\jumingo\Model\CartTotalInput $cart The List of shipment id and voucher code (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postCartTotal'] to see the possible values for this operation
     *
     * @throws \kruegge82\jumingo\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\jumingo\Model\CartTotalOutput|\kruegge82\jumingo\Model\ErrorResponse
     */
    public function postCartTotal($cart, string $contentType = self::contentTypes['postCartTotal'][0])
    {
        list($response) = $this->postCartTotalWithHttpInfo($cart, $contentType);
        return $response;
    }

    /**
     * Operation postCartTotalWithHttpInfo
     *
     * Get cart total
     *
     * @param  \kruegge82\jumingo\Model\CartTotalInput $cart The List of shipment id and voucher code (required)
     ...
     * @throws \kruegge82\jumingo\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\jumingo\Model\CartTotalOutput|\kruegge82\jumingo\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCartTotalWithHttpInfo($cart, string $contentType = self::contentTypes['postCartTotal'][0])
    {
        $request = $this->postCartTotalRequest($cart, $contentType);
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\kruegge82\jumingo\Model\CartTotalOutput',
                        $request,
                        $response,
                    );
                case 400:
     ...
     */
    public function postCartTotalAsync($cart, string $contentType = self::contentTypes['postCartTotal'][0])
    {
        return $this->postCartTotalAsyncWithHttpInfo($cart, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postCartTotalAsyncWithHttpInfo
     *
     * Get cart total
     *
     * @param  \kruegge82\jumingo\Model\CartTotalInput $cart The List of shipment id and voucher code (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCartTotalAsyncWithHttpInfo($cart, string $contentType = self::contentTypes['postCartTotal'][0])
    {
        $returnType = '\kruegge82\jumingo\Model\CartTotalOutput';
        $request = $this->postCartTotalRequest($cart, $contentType);
    ...
    /**
     * Create request for operation 'postCartTotal'
     *
     * @param  \kruegge82\jumingo\Model\CartTotalInput $cart The List of shipment id and voucher code (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postCartTotal'] to see the possible values for this operation
     *
     ...
     */
    public function postCartTotalRequest($cart, string $contentType = self::contentTypes['postCartTotal'][0])
    {

        // verify the required parameter 'cart' is set
        if ($cart === null || (is_array($cart) && count($cart) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cart when calling postCartTotal'
            );
        }


        $resourcePath = '/v1/cart/total';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
